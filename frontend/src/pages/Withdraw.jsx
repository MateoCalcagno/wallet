...
function Withdraw() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Error al retirar')
    }
  }
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Izquierda */}
      <AuthPanel title={"Retirá tu dinero\ncuando quieras."} subtitle="Mové fondos a tu cuenta externa fácilmente." />
      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-14 bg-white">
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-medium text-gray-900 mb-1">Retirar dinero</h1>
            <p className="text-sm text-gray-500">Ingresá el monto a retirar</p>
          </div>
